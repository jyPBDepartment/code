...
public class EduExamPaperInfoEntity {
	...
	private int status;
	@Column(columnDefinition = "DECIMAL(10,1) default null comment '总分值'")
	private Double totalScore;
	@Column(columnDefinition = "DECIMAL(10,1) default null comment '及格分数'")
	private Double passScore;
	@Column(columnDefinition = "int(4) default null comment '答题时间'")

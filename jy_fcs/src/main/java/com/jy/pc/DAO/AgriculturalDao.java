...
//	搜索发布信息中农服信息(标题名称)
	...
	public Page<AgriculturalEntity> findAgriInfo(String name, String transactionTypeCode, String transactionCategoryCode,Map<String, List<String>> map, Pageable pageable);

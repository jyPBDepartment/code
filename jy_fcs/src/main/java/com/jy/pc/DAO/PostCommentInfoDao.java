...
public interface PostCommentInfoDao extends JpaRepository<PostCommentInfoEntity, String>{
	...
	@Query(value="select * from sas_post_comment_info t where t.post_id =:postId",nativeQuery = true)
	public List<PostCommentInfoEntity> findByPost(@Param("postId")String postId);
